...
def svm_loss_vectorized(
    ...
    #############################################################################
    # Replace "pass" statement with your code
    # Create a binary mask for margins > 0
    binary = (margins > 0).float()
    
    # Count how many classes have positive margin for each sample
